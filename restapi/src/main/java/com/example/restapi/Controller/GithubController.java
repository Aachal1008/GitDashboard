...
public class GithubController {
    ...
    public ResponseEntity<String> githubcontroller()
    {
        ...
        ResponseEntity<String> string = restTemplete.getForEntity("https://api.github.com/users/mojombo/repos", String.class);
        return string;
    ...
    public ResponseEntity<String> githubcontrollercommit()
    {
        ...
        ResponseEntity<String> string = restTemplete.getForEntity("https://api.github.com/repos/mojombo/30daysoflaptops.github.io/commits", String.class);
        return string;
